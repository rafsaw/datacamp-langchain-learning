...
raw_documents = WikipediaLoader(query="Kobong", lang="pl").load() 
text_splitter = TokenTextSplitter(chunk_size=100, chunk_overlap=20)  
documents = text_splitter.split_documents(raw_documents)   

# Save all documents to text file
with open('wikipedia_kobong_output.txt', 'w', encoding='utf-8') as f:
...
print("Output saved to 'wikipedia_kobong_output.txt'")
...
graph = Neo4jGraph(url=url, username=user, password=password, database="kobong")
